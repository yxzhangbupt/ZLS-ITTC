...
//        });
    ...
    $("#btn_last").click(function(){
        window.location.assign("./GN_getWater.jsp");
    });
    $("#btn_next").click(function(){
        window.location.assign("./GN_JJ.jsp");
    });
    $("#btn_home").click(function(){
        window.location.assign("./GN_FMControl.jsp");
    });
    $("#btn_new").click(function(){
        window.location.assign("./GN_HH_new.jsp");
    });
...
//        HH2_Y1
//        $.post("./updateYOnload.jsp",{id:"MTG_HH2_Y01",t:t},function(Onload){
////        	alert(data);
//            HH2_Y01.height_now=parseFloat(Onload);
//            document.getElementById("readout_HH2_Y1_Onload").innerHTML="井2堰2负载："+parseFloat(Onload)+"%";
//            if(parseFloat(Onload)){
//                HH2_Y01.fill="#0767c8";
//            }
//            else{
//                HH2_Y01.fill="#43d9f9";
...
//            document.getElementById("readout_HH2_Y1_Vnow").innerHTML = "井2堰1水量：" +parseFloat(VNow)+"立方米";
//        });
//        //HH2_Y2
