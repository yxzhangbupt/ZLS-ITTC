    ...
    controllers.controller('showJjcCtrl', ['$scope', '$stateParams', function ($scope, $statePrams) {
        ...
        $scope.restart= function () {
            ...
            function reset(){
                ...
                arrow_6.stopAnimation();
                arrow_7.stopAnimation();
                arrow_101.stopAnimation();
                arrow_102.stopAnimation();
                arrow_111.stopAnimation();
                arrow_112.stopAnimation();
                arrow_81.stopAnimation();
                arrow_82.stopAnimation();
                arrow_83.stopAnimation();
                arrow_84.stopAnimation();
                arrow_85.stopAnimation();
                arrow_91.stopAnimation();
                arrow_92.stopAnimation();
                arrow_93.stopAnimation();
                arrow_94.stopAnimation();
                arrow_95.stopAnimation();
                arrow_1.frame=1;
                arrow_2.frame=1;
                arrow_3.frame=1;
                arrow_4.frame=1;
