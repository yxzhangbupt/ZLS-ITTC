...
define(['./module', 'oCanvas','myoCanvas'], function (controllers, oCanvas) {
    'use strict';
    controllers.controller('ZPNewCtrl', ['$scope', function ($scope) {
        var speed_all=1.5,
            width_all=20,
            speed_SC=0.9,
            color_GD="#007fff",
        ...
        $("#btn_reset_ZP").click(function(){
            ...
            $("#btn_start_ZP").innerText='暂停';
            $("#btn_start_ZP").value=0;


        });
        $("#btn_upS_ZP").click(function(){
            canvas.settings.fps+=5;

            document.getElementById("txt_speed").innerHTML=((canvas.settings.fps-50)/50+1.0);
            canvas.redraw();
        });
        $("#btn_downS_ZP").click(function () {
